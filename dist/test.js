var p5svg = (function () {
	...
	var pathval;
	var hasRequiredPathval;

	function requirePathval () {
		if (hasRequiredPathval) return pathval;
		hasRequiredPathval = 1;
	...
	function requireFlag () {
		...
		flag = function flag(obj, key, value) {
	...
	var expectTypes;
	var hasRequiredExpectTypes;

	function requireExpectTypes () {
		if (hasRequiredExpectTypes) return expectTypes;
		hasRequiredExpectTypes = 1;
		/**
		...
		var AssertionError = requireAssertionError();
		var flag = requireFlag();
		var type = requireTypeDetect();

		expectTypes = function expectTypes(obj, types) {
	...
	var getActual;
	var hasRequiredGetActual;

	function requireGetActual () {
		if (hasRequiredGetActual) return getActual;
		hasRequiredGetActual = 1;
		/**
		...
		getActual = function getActual(obj, args) {
	...
	var getFuncName_1;
	var hasRequiredGetFuncName;

	function requireGetFuncName () {
		if (hasRequiredGetFuncName) return getFuncName_1;
		hasRequiredGetFuncName = 1;
		...
		getFuncName_1 = getFuncName;
		return getFuncName_1;
	}
	...
	var getProperties;
	var hasRequiredGetProperties;

	function requireGetProperties () {
		if (hasRequiredGetProperties) return getProperties;
		hasRequiredGetProperties = 1;
		/**
	...
	var hasRequiredGetEnumerableProperties;

	function requireGetEnumerableProperties () {
		if (hasRequiredGetEnumerableProperties) return getEnumerableProperties;
		hasRequiredGetEnumerableProperties = 1;
		/**
		...
		getEnumerableProperties = function getEnumerableProperties(object) {
		  var result = [];
	...
	function requireInspect () {
		if (hasRequiredInspect) return inspect.exports;
		hasRequiredInspect = 1;
		(function (module, exports) {
			// This is (almost) directly from Node.js utils
			// https://github.com/joyent/node/blob/f8c335d0caf47f16d31413f89aa28eda3878e3aa/lib/util.js

			var getName = requireGetFuncName();
			var getProperties = requireGetProperties();
			var getEnumerableProperties = requireGetEnumerableProperties();
		...
		} (inspect, inspect.exports));
		return inspect.exports;
	}
	...
	var objDisplay;
	var hasRequiredObjDisplay;

	function requireObjDisplay () {
		if (hasRequiredObjDisplay) return objDisplay;
		hasRequiredObjDisplay = 1;
		/*!
		 * Module dependencies
		 */

		var inspect = requireInspect();
		var config = requireConfig();
		...
		objDisplay = function objDisplay(obj) {
		  var str = inspect(obj)
	...
	var getMessage;
	var hasRequiredGetMessage;

	function requireGetMessage () {
		if (hasRequiredGetMessage) return getMessage;
		hasRequiredGetMessage = 1;
		/*!
		 * Module dependencies
		 */

		var flag = requireFlag()
		  , getActual = requireGetActual()
		  , objDisplay = requireObjDisplay();
		...
		getMessage = function getMessage(obj, args) {
		  var negate = flag(obj, 'negate')
		    , val = flag(obj, 'object')
		    , expected = args[3]
	...
	var transferFlags;
	var hasRequiredTransferFlags;

	function requireTransferFlags () {
		if (hasRequiredTransferFlags) return transferFlags;
		hasRequiredTransferFlags = 1;
		/**
		...
		transferFlags = function transferFlags(assertion, object, includeAll) {
	...
	var isProxyEnabled;
	var hasRequiredIsProxyEnabled;

	function requireIsProxyEnabled () {
		if (hasRequiredIsProxyEnabled) return isProxyEnabled;
		hasRequiredIsProxyEnabled = 1;
		var config = requireConfig();
	...
	function requireAddProperty () {
		...
		var chai = requireChai$1();
		var flag = requireFlag();
		var isProxyEnabled = requireIsProxyEnabled();
		var transferFlags = requireTransferFlags();
	...
	var addLengthGuard;
	var hasRequiredAddLengthGuard;

	function requireAddLengthGuard () {
		if (hasRequiredAddLengthGuard) return addLengthGuard;
		hasRequiredAddLengthGuard = 1;
		...
		addLengthGuard = function addLengthGuard (fn, assertionName, isChainable) {
		...
		return addLengthGuard;
	}

	var proxify;
	var hasRequiredProxify;

	function requireProxify () {
		if (hasRequiredProxify) return proxify;
		hasRequiredProxify = 1;
		var config = requireConfig();
		var flag = requireFlag();
		var getProperties = requireGetProperties();
		var isProxyEnabled = requireIsProxyEnabled();
		...
		proxify = function proxify(obj, nonChainableMethodName) {
	...
	function requireAddMethod () {
		...
		var addLengthGuard = requireAddLengthGuard();
		var chai = requireChai$1();
		var flag = requireFlag();
		var proxify = requireProxify();
		var transferFlags = requireTransferFlags();
	...
	var compareByInspect;
	var hasRequiredCompareByInspect;

	function requireCompareByInspect () {
		if (hasRequiredCompareByInspect) return compareByInspect;
		hasRequiredCompareByInspect = 1;
		/*!
		 * Module dependencies
		 */
		...
		compareByInspect = function compareByInspect(a, b) {
		  return inspect(a) < inspect(b) ? -1 : 1;
		};
		return compareByInspect;
	}
	...
	var hasRequiredGetOwnEnumerablePropertySymbols;

	function requireGetOwnEnumerablePropertySymbols () {
		if (hasRequiredGetOwnEnumerablePropertySymbols) return getOwnEnumerablePropertySymbols;
		hasRequiredGetOwnEnumerablePropertySymbols = 1;
		/**
		...
		getOwnEnumerablePropertySymbols = function getOwnEnumerablePropertySymbols(obj) {
		...
		return getOwnEnumerablePropertySymbols;
	}
	...
	var hasRequiredGetOwnEnumerableProperties;

	function requireGetOwnEnumerableProperties () {
		if (hasRequiredGetOwnEnumerableProperties) return getOwnEnumerableProperties;
		hasRequiredGetOwnEnumerableProperties = 1;
		/*!
		 * Module dependencies
		 */

		var getOwnEnumerablePropertySymbols = requireGetOwnEnumerablePropertySymbols();
		...
		getOwnEnumerableProperties = function getOwnEnumerableProperties(obj) {
		  return Object.keys(obj).concat(getOwnEnumerablePropertySymbols(obj));
		};
		return getOwnEnumerableProperties;
	}

	var checkError;
	var hasRequiredCheckError;

	function requireCheckError () {
		if (hasRequiredCheckError) return checkError;
		hasRequiredCheckError = 1;
	...
	var getOperator;
	var hasRequiredGetOperator;

	function requireGetOperator () {
		if (hasRequiredGetOperator) return getOperator;
		hasRequiredGetOperator = 1;
		var type = requireTypeDetect();
		...
		getOperator = function getOperator(obj, args) {
	...
	function requireUtils () {
		...
		utils.getOperator = requireGetOperator();
		return utils;
	}
	...
	var assertion;
	var hasRequiredAssertion;

	function requireAssertion () {
		if (hasRequiredAssertion) return assertion;
		hasRequiredAssertion = 1;
		var config = requireConfig();

		assertion = function (_chai, util) {
		  /*!
		   * Module dependencies.
		   */
	...
	var expect$1;
	var hasRequiredExpect;

	function requireExpect () {
		if (hasRequiredExpect) return expect$1;
		hasRequiredExpect = 1;
		expect$1 = function (chai, util) {
	...
	var should;
	var hasRequiredShould;

	function requireShould () {
		if (hasRequiredShould) return should;
		hasRequiredShould = 1;
		should = function (chai, util) {
		  var Assertion = chai.Assertion;
	...
	var hasRequiredChai$1;

	function requireChai$1 () {
		if (hasRequiredChai$1) return chai$2;
		hasRequiredChai$1 = 1;
		(function (exports) {
			var used = [];
			...
			exports.AssertionError = requireAssertionError();
			...
			var assertion = requireAssertion();
	...
	function requireChai () {
		if (hasRequiredChai) return chai$1;
		hasRequiredChai = 1;
		chai$1 = requireChai$1();
		return chai$1;
	}

	var chaiExports = requireChai();
	var chai = /*@__PURE__*/getDefaultExportFromCjs(chaiExports);
	...
	var hasRequiredSvgcanvas;

	function requireSvgcanvas () {
		if (hasRequiredSvgcanvas) return svgcanvas;
		hasRequiredSvgcanvas = 1;
		...
		svgcanvas.Element = SVGCanvasElement;
		return svgcanvas;
	}

	var svgcanvasExports = requireSvgcanvas();
	...
	class RendererTester {
	    ...
	    async test(options = {
	        ...
	        // Pixels
	        const svg = svgcanvasExports.Element.prototype.toDataURL.call({ svg: this.p5svg._renderer.svg }, 'image/svg+xml');
	        const svgImage = await new Promise((resolve) => {
	            var svgImage = new Image();
	            svgImage.onload = function () {
	                resolve(svgImage);
	...
	var index = /*@__PURE__*/getDefaultExportFromCjs(unitExports);
